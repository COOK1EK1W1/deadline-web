  ...
  return (
    <div>
      <form action={navigate} className="m-2 w-[400px] border-2 dark:border-slate-600 border-slate-300 w-3/4 rounded-2xl p-4 flex flex-col items-center mt-10">
          <input name="code" className="p-1 m-1 rounded px-2 dark:bg-slate-600 bg-white" placeholder="Enter programme code"/>
          <button type="submit" className="w-40 m-1 p-1 dark:bg-slate-600 bg-slate-300 rounded-full">Go</button>
      </form>
      <div className="m-2 w-[400px] border-2 dark:border-slate-600 border-slate-300 w-3/4 rounded-2xl p-4 mt-20">
        ...
        <Link className="p-1 m-1 dark:bg-slate-600 bg-slate-300 rounded-full text-center w-60" href={"/CS24-4"}>
